...
export const es: typeof zhCN = {
    ...
    vp_priority: "Orden de prioridad de versiones",
    vp_keywords: "Etiquetas de versión",
    vp_keywords_desc:
        "Cuando existen múltiples archivos para el mismo episodio, gana el que tenga en su ruta la etiqueta más alta de esta lista. Ejemplo: «TeamX → GroupA → StreamB» — si existen las tres versiones, se elige TeamX; si no, GroupA; y así sucesivamente",
    vp_keywords_placeholder: "p. ej. TeamX, GroupA, StreamB",
    ...
    vp_filter: "Huella de versión",
    vp_filter_desc:
        "Extrae características de versión del archivo en reproducción como «huella». Solo los episodios cuyas rutas coincidan exactamente con el mismo conjunto de características se añaden a la lista de reproducción, fijando toda la temporada a la misma versión. Ejemplo: si el regex coincide con «TeamX» y «1080p» en el archivo actual, solo los episodios que contengan ambas palabras se incluyen (vacío = sin filtro)",
    vp_filter_placeholder: "p. ej. |TeamX|1080p|CHS",
    ...
    net_proxy_desc:
        "Solo host:port; pega una URL completa para detectar el esquema automáticamente; vacío para desactivar",
    net_proxy_https_desc:
        "Se usa para conexiones cifradas (HTTPS); si está vacío, recae en el proxy HTTP; mismo formato que HTTP",
    net_proxy_socks5_desc:
        "Enruta todo el tráfico de protocolos; ideal para redes sin túnel HTTP; dejar vacío para desactivar",
    ...
    map_remove: "Quitar",
    map_copy: "Copiar",
    map_group_add: "Nuevo grupo",
    map_group_name_placeholder: "Nombre del grupo",
    map_group_add_confirm: "Crear",
    map_group_delete: "Eliminar grupo",
    map_group_delete_confirm: "¿Eliminar el grupo «{name}» y todas sus asignaciones?",
    map_item_delete_title: "Quitar asignación",
    map_item_delete_confirm: "¿Quitar esta entrada?\n{entry}",
    map_group_default_label: "Predeterminado",
    map_export: "Exportar",
    map_export_done: "Asignaciones exportadas",
    map_import: "Importar",
    map_import_prefer: "Preferir importado (sobrescribir conflictos locales)",
    map_import_done: "Importación completada: añadidas {added}, reemplazadas {replaced}",
    map_import_url: "Importar desde URL",
    ...
    cfg_update_available: "Nueva versión v{version} encontrada",
    cfg_update_latest: "Tienes la versión más reciente v{version}",
    cfg_update_current_ver: "Versión actual",
    cfg_update_latest_ver: "Última versión",
    cfg_update_up_to_date: "Actualizado",
    cfg_update_install: "Descargar e instalar",

    // Update banner (overview)
    ov_update_available: "Nueva versión v{version} disponible",
    ov_update_action: "Instalar actualización",
    ov_update_dismiss: "Descartar esta versión",
    ov_update_downloading: "Descargando actualización…",
    ov_update_failed: "Error al actualizar",
    ov_update_extracting: "Extrayendo actualización…",
    ov_update_installing: "Instalando la nueva versión…",
    ...
    sys_app_icon: "Icono personalizado",
    sys_app_icon_desc:
        "Elige una imagen PNG para el icono de marca dentro de la ventana; resolución mínima 512x512",
    sys_app_icon_choose: "Elegir imagen",
    sys_app_icon_reset: "Restablecer",
    sys_app_icon_saved: "Icono actualizado",
    sys_app_icon_reset_done: "Icono predeterminado restaurado",
    ...
    dl_folder_desc: "Dejar vacío para usar la carpeta predeterminada del sistema",
    dl_browse: "Explorar…",
    dl_placeholder: "",
    dl_path_error: "La ruta no existe, verifique la entrada",

    // Bangumi duplicate throttle
    sys_bangumi_dup: "Permitir marcados duplicados",
    sys_bangumi_dup_desc:
        "Cuando está activado, vuelve a marcar el mismo episodio/película cada vez que terminas de verlo; cuando desactivado, la deduplicación con limitación es activa: el mismo elemento solo se marca una vez dentro de la ventana configurada abajo",
    sys_bangumi_dup_throttle: "Tiempo de limitación de marcados duplicados (segundos)",
    sys_bangumi_dup_throttle_desc:
        "Activo cuando Permitir marcados duplicados está desactivado: el mismo elemento se registra como máximo una vez dentro de este número de segundos; mínimo 120 segundos",
    sys_bangumi_dup_throttle_floored:
        "La limitación no puede ser menor a 120 s — corregida a 120",
