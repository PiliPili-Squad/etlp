...
export const sr: typeof zhCN = {
    ...
    sys_trakt_enabled: "Укључи Trakt синхронизацију",
    sys_trakt_enabled_desc:
        "Када је искључено, подаци о гледању се не синхронизују са Trakt",
    ...
    sys_bangumi_enabled: "Укључи Bangumi синхронизацију",
    sys_bangumi_enabled_desc:
        "Када је искључено, подаци о гледању се не синхронизују са Bangumi",
    ...
    sys_brand_logo: "Прикажи област бренда",
    sys_brand_logo_desc:
        "Сакрива лого и назив изнад картица; мени се аутоматски помера нагоре",
    ...
    sys_app_icon_desc:
        "Изаберите PNG слику за икону бренда у прозору; минимална резолуција је 512x512",
    ...
    sys_material_opacity: "Интензитет материјала",
    sys_material_opacity_desc:
        "0% се стапа са основом прозора, 100% приказује најпунији материјал панела",
    sys_live_backdrop: "Замућење позадине уживо",
    sys_live_backdrop_desc:
        "Када је искључено, користи статички материјал ради стабилног скроловања; када је укључено, стварно замућује садржај иза прозора и тражи више перформанси",
    sys_material_blur: "Замућење позадине",
    sys_material_blur_desc:
        "Подесите радијус замућења материјала; више вредности јаче замућују садржај испод прозора",
