...
export const it: typeof zhCN = {
    ...
    vp_priority: "Ordine di priorità versioni",
    vp_keywords: "Etichette versione",
    vp_keywords_desc:
        "Se esistono più file per lo stesso episodio, vince quello il cui percorso corrisponde all'etichetta più in alto della lista. Esempio: «TeamX → GroupA → StreamB» — se tutte e tre le versioni esistono, si sceglie TeamX; altrimenti GroupA; e così via",
    vp_keywords_placeholder: "es. TeamX, GroupA, StreamB",
    ...
    vp_filter: "Impronta digitale versione",
    vp_filter_desc:
        "Estrae caratteristiche di versione dal percorso del file in riproduzione come «impronta digitale». Solo gli episodi i cui percorsi corrispondono esattamente allo stesso insieme di caratteristiche vengono aggiunti alla playlist, bloccando l'intera stagione alla stessa versione. Esempio: se il regex corrisponde a «TeamX» e «1080p» nel file attuale, vengono inclusi solo gli episodi che contengono entrambe le parole (vuoto = disabilitato)",
    vp_filter_placeholder: "es. |TeamX|1080p|CHS",
    ...
    net_proxy_desc:
        "Solo host:port; incolla un URL completo per rilevare lo schema automaticamente; vuoto per disattivare",
    net_proxy_https_desc:
        "Usato per connessioni crittografate (HTTPS); se vuoto, ricade sul proxy HTTP; stesso formato di HTTP",
    net_proxy_socks5_desc:
        "Instrada tutto il traffico di protocolli; ideale per reti senza tunnel HTTP; lasciare vuoto per disabilitare",
    net_proxy_enabled: "Abilita proxy",
    net_proxy_enabled_desc:
        "Se disabilitato, l'URL viene mantenuto ma tutte le connessioni sono dirette; gli IP privati (192.168.x, 10.x ecc.) vengono bypassati automaticamente",
    net_skip_tls: "Salta verifica TLS",
    net_skip_tls_desc: "Per server multimediali autofirmati — non sicuro",
    ...
    map_remove: "Rimuovi",
    map_copy: "Copia",
    map_group_add: "Nuovo gruppo",
    map_group_name_placeholder: "Nome gruppo",
    map_group_add_confirm: "Crea",
    map_group_delete: "Elimina gruppo",
    map_group_delete_confirm: 'Eliminare il gruppo "{name}" e tutte le sue voci?',
    map_item_delete_title: "Rimuovi voce",
    map_item_delete_confirm: "Rimuovere questa voce?\n{entry}",
    map_group_default_label: "Predefinito",
    map_export: "Esporta",
    map_export_done: "Mappature esportate",
    map_import: "Importa",
    map_import_prefer: "Preferisci importato (sovrascrivi conflitti locali)",
    map_import_done: "Importazione completata: aggiunte {added}, sostituite {replaced}",
    map_import_url: "Importa da URL",
    ...
    cfg_update_available: "Nuova versione v{version} trovata",
    cfg_update_latest: "Stai usando la versione più recente v{version}",
    cfg_update_current_ver: "Versione corrente",
    cfg_update_latest_ver: "Versione più recente",
    cfg_update_up_to_date: "Aggiornato",
    cfg_update_install: "Scarica e installa",

    // Update banner (overview)
    ov_update_available: "Nuova versione v{version} disponibile",
    ov_update_action: "Installa aggiornamento",
    ...
    dl_folder_desc: "Lasciare vuoto per usare la cartella predefinita del sistema",
    dl_browse: "Sfoglia…",
    dl_placeholder: "",
    dl_path_error: "Percorso inesistente, verifica l'input",

    // Bangumi duplicate throttle
    sys_bangumi_dup: "Consenti marcature duplicate",
    sys_bangumi_dup_desc:
        "Quando attivato, rimarca lo stesso episodio/film ogni volta che finisci di guardarlo; quando disattivato si attiva la deduplicazione con limitazione: lo stesso elemento viene marcato solo una volta nella finestra di limitazione impostata sotto",
    sys_bangumi_dup_throttle: "Tempo di limitazione marcature duplicate (secondi)",
    sys_bangumi_dup_throttle_desc:
        "Attivo quando Consenti marcature duplicate è disattivato: lo stesso elemento viene registrato al massimo una volta entro questo numero di secondi; minimo 120 secondi",
    sys_bangumi_dup_throttle_floored:
        "La limitazione non può essere inferiore a 120 s — corretta a 120",

    // TMDB
    sys_tmdb: "Integrazione TMDB",
    sys_tmdb_key: "Chiave API",
    sys_tmdb_key_desc:
        "Chiave API TMDB per recuperare i metadati mancanti dal server multimediale durante la sincronizzazione.",
    sys_tmdb_api_link: "Crea una chiave API",
